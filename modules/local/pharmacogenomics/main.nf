process PHARMACOGENOMICS {
    ...
    script:
        ...
        if( meta.id.size() >= 2 ) {
            ...
            echo -e "${meta.clarity_sample_id[normal_idx]},${meta.id[normal_idx]},${meta.id[normal_idx]},N,GMS_PGx_Panel,${meta.group[normal_idx]},${args}/${normal_bam}.bam,${args}/${normal_bam}.bam.bai,${meta.purity[normal_idx]}" >> ${prefix}.pgx${suffix}.csv
            ...
            """
            echo -e "clarity_sample_id,id,type,assay,group,bam,bai,purity" > ${prefix}.pgx${suffix}.csv
            echo -e "${meta.clarity_sample_id[0]},${meta.id[0]},${meta.id[0]},${meta.type[0]},GMS_PGx_Panel,${meta.group[0]},${args}/${bam}.bam,${args}/${bam}.bam.bai,${meta.purity[0]}" >> ${prefix}.pgx${suffix}.csv
