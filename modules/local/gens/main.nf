process GENS_YAML {
    ...
    input:
        tuple val(group), val(meta_list), file(baf_files), file(cov_files), val(loh_bed) // loh_bed can be null, and thus cannot be file=> val instead
    ...
    script:
        ...
        def loh_args     = loh_bed ? "--loh_bed_filename ${loh_bed}" : ""
