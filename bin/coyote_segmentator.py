...
def build_parser():
    ...
    parser.add_argument("--vcf", required=True, help="Merged SV VCF.")
    parser.add_argument("--sample-id", required=True, help="Sample ID.")
    parser.add_argument("--panel", required=True, help="Comma-delimited panel definition files.")
    parser.add_argument("--genes", required=True, help="Gene BED file.")
...
def main(argv=None):
    ...
    coyote_segmentator(args.vcf, args.sample_id, args.panel, args.genes, args.normal, args.out_prefix)
    return 0
